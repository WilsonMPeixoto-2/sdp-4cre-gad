export const SectionIntro = () => {
  return (
    <section id="introducao" className="scroll-mt-20 animate-fade-in" aria-label="Apresentação e boas-vindas">
      {/* Welcome Message */}
      <div className="section-card">
        ...
        <div className="content-spacing">
          <p className="text-justify drop-cap">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-8 pt-6 border-t border-border">
          <div className="text-center p-5 bg-gradient-to-br from-secondary to-secondary/50 rounded-xl">
            <p className="font-bold text-foreground">Fátima das Graças Lima Barros</p>
            <p className="text-sm text-muted-foreground mt-1">Coordenadora – E/4ª CRE</p>
          </div>
          <div className="text-center p-5 bg-gradient-to-br from-secondary to-secondary/50 rounded-xl">
            <p className="font-bold text-foreground">Bianca Barreto da Fonseca Coelho</p>
            <p className="text-sm text-muted-foreground mt-1">Gerente – E/4ª CRE/GAD</p>
          </div>
        </div>
      </div>
    </section>

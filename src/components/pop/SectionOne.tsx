  ...
  return (
    <section id="secao-1" className="scroll-mt-20 animate-fade-in">
      ...
      <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div className="section-number text-base sm:text-lg">1</div>
        <div>
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="section-card p-4 sm:p-6">
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2 text-sm sm:text-base">1.1. Sobre esta etapa</h3>
        ...
        {/* Steps */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.2. Iniciando o Processo</h3>
          ...
          <div className="bg-secondary rounded-lg p-3 sm:p-4 mb-4">
            <p className="text-xs sm:text-sm font-medium text-foreground mb-2">Menu do Sistema:</p>
        ...
        {/* Type Selection */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.3. Seleção do Tipo de Processo</h3>
          <p className="text-muted-foreground mb-4 text-sm sm:text-base">
          ...
          <div className="highlight-box">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-foreground text-sm sm:text-base">Tipo de Processo Correto:</span>
            </div>
        ...
        {/* Classification */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.5. Classificação por Assuntos</h3>
          <p className="text-muted-foreground mb-4 text-sm sm:text-base">
          ...
          <div className="bg-secondary rounded-lg p-3 sm:p-4">
            <p className="text-xs sm:text-sm text-muted-foreground mb-2">Classificação automática:</p>
            <code className="block bg-card px-3 sm:px-4 py-2 rounded border text-xs sm:text-sm font-mono text-foreground break-all">
        ...
        {/* Specification */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.8. Especificação</h3>
          <p className="text-muted-foreground mb-4 text-sm sm:text-base">
          ...
          <div className="highlight-box">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-foreground text-sm sm:text-base">Exemplo de Especificação:</span>
            </div>
        ...
        {/* Access Level */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.11. Nível de Acesso</h3>
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <div className="min-w-[500px] sm:min-w-0 px-4 sm:px-0">
              <table className="table-institutional text-xs sm:text-sm">
                <thead>
                  <tr>
                    <th className="w-24 sm:w-32">Nível</th>
                    <th>Descrição</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div className="highlight-box mt-4">
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground mb-1 text-sm sm:text-base">Princípio da Publicidade</p>
        ...
        {/* Interessados */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.12. Interessados</h3>
          <p className="text-muted-foreground text-sm sm:text-base">
        ...
        {/* Observações */}
        <div className="section-card p-4 sm:p-6">
          <h3 className="font-semibold text-foreground mb-3 sm:mb-4 text-sm sm:text-base">1.13. Observações da Unidade</h3>
          <p className="text-muted-foreground text-sm sm:text-base">

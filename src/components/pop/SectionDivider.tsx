...
export const SectionDivider = ({ number, title, subtitle, icon: Icon }: SectionDividerProps) => {
  return (
    <div className="relative py-14 sm:py-18 my-8 sm:my-12 -mx-4 sm:-mx-0 section-divider-print">
      {/* Premium Gradient Background */}
      <div className="absolute inset-0 overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(215, 75%, 32%) 0%, hsl(215, 75%, 26%) 50%, hsl(215, 75%, 22%) 100%)' }}>
        {/* Subtle Pattern */}
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center gap-5 sm:gap-7 px-4 sm:px-8 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-center w-18 h-18 sm:w-22 sm:h-22 bg-primary-foreground text-primary rounded-2xl font-heading font-extrabold text-2xl sm:text-3xl shrink-0 shadow-2xl" style={{ width: '4.5rem', height: '4.5rem' }}>
          {number}
        </div>

...
export const SectionDivider = ({ number, title, subtitle, icon: Icon }: SectionDividerProps) => {
  return (
    <div className="relative py-12 sm:py-16 my-8 sm:my-12 -mx-4 sm:-mx-0 section-divider-print">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-r from-primary via-primary to-[hsl(215,70%,30%)] overflow-hidden print:bg-primary">

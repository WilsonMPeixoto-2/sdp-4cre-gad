  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 py-16 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-5 max-w-4xl mx-auto mb-12 stagger-animation">
          {[
            ...
            <div
              key={i}
              className="glass-premium rounded-2xl p-5 text-center transition-all duration-300 hover:-translate-y-1 hover:bg-white/15 hover:border-white/30 hover:shadow-xl group cursor-pointer tilt-hover"
            >
